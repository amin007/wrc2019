...
?>
<script>
$('#F1318xx').keyup(function(){
<?php foreach ($kiraF as $ff):?>
	var F1318<?php echo $ff ?>;
	F1318<?php echo $ff ?> = parseFloat($('#F1318<?php echo $ff ?>').val());
<?php endforeach; ?>
...
?>
<script>
$('#F1418xx').keyup(function(){
<?php foreach ($kiraF as $ff):?>
	var F1418<?php echo $ff ?>;
	F1418<?php echo $ff ?> = parseFloat($('#F1418<?php echo $ff ?>').val());
<?php endforeach; ?>
//	var result = F00<?php echo $ff ?>a + F00<?php echo $ff ?>b + F00<?php echo $ff ?>c;
//	$('#F00<?php echo $ff ?>').val(result.toFixed(0));
});
